...
#define __PYX_HAVE__vrsubtitlemaker__add_patterns_lib__alpha_blend
#define __PYX_HAVE_API__vrsubtitlemaker__add_patterns_lib__alpha_blend
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
/* Module declarations from 'vrsubtitlemaker.add_patterns_lib.alpha_blend' */
...
static PyObject *__pyx_f_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_AlphaBlend(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "vrsubtitlemaker.add_patterns_lib.alpha_blend"
extern int __pyx_module_is_main_vrsubtitlemaker__add_patterns_lib__alpha_blend;
int __pyx_module_is_main_vrsubtitlemaker__add_patterns_lib__alpha_blend = 0;

/* Implementation of 'vrsubtitlemaker.add_patterns_lib.alpha_blend' */
...
static const char __pyx_k_img_front[] = "img_front";
...
static const char __pyx_k_img_blended[] = "img_blended";
...
static PyObject *__pyx_n_s_img_blended;
static PyObject *__pyx_n_s_img_front;
...
static PyObject *__pyx_pf_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_AlphaBlend(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img_back, __Pyx_memviewslice __pyx_v_img_front, __Pyx_memviewslice __pyx_v_img_blended); /* proto */
...
/* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":10
...
static PyObject *__pyx_pw_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_1AlphaBlend(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_AlphaBlend(__Pyx_memviewslice __pyx_v_img_back, __Pyx_memviewslice __pyx_v_img_front, __Pyx_memviewslice __pyx_v_img_blended, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_width;
  int __pyx_v_height;
  ...
  __Pyx_RefNannySetupContext("AlphaBlend", 0);

  /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":13
 *                  np.uint8_t[:,:,:] img_blended):
 *   cdef:
 ...
 */
  __pyx_v_width = (__pyx_v_img_back.shape[1]);

  /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":14
 *   cdef:
 *     int width = img_back.shape[1]
 *     int height = img_back.shape[0]             # <<<<<<<<<<<<<<
 *     int n_channels = img_back.shape[2]
 *     int i, j, c
 */
  __pyx_v_height = (__pyx_v_img_back.shape[0]);

  /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":15
 *     int width = img_back.shape[1]
 *     int height = img_back.shape[0]
 *     int n_channels = img_back.shape[2]             # <<<<<<<<<<<<<<
 *     int i, j, c
 ...
 */
  __pyx_v_n_channels = (__pyx_v_img_back.shape[2]);

  /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":19
 *     float alpha1, alpha2, alpha
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":20
 * 
 *   for i in range(width):
 *     for j in range(height):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":22
 *     for j in range(height):
 * 
 *       alpha1 = 1.0 * img_back[i, j, 3] / 255             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_8 = __pyx_v_j;
      __pyx_t_9 = 3;
      __pyx_v_alpha1 = ((1.0 * (*((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_back.data + __pyx_t_7 * __pyx_v_img_back.strides[0]) ) + __pyx_t_8 * __pyx_v_img_back.strides[1]) ) + __pyx_t_9 * __pyx_v_img_back.strides[2]) )))) / 255.0);

      /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":23
 * 
 *       alpha1 = 1.0 * img_back[i, j, 3] / 255
 *       alpha2 = 1.0 * img_front[i, j, 3] / 255             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_12 = 3;
      __pyx_v_alpha2 = ((1.0 * (*((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_front.data + __pyx_t_10 * __pyx_v_img_front.strides[0]) ) + __pyx_t_11 * __pyx_v_img_front.strides[1]) ) + __pyx_t_12 * __pyx_v_img_front.strides[2]) )))) / 255.0);

      /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":25
 *       alpha2 = 1.0 * img_front[i, j, 3] / 255
 * 
 *       alpha = 1 - (1 - alpha1) * (1 - alpha2)             # <<<<<<<<<<<<<<
 * 
 *       for c in range(3):
 */
      __pyx_v_alpha = (1.0 - ((1.0 - __pyx_v_alpha1) * (1.0 - __pyx_v_alpha2)));

      /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":27
 *       alpha = 1 - (1 - alpha1) * (1 - alpha2)
 * 
 *       for c in range(3):             # <<<<<<<<<<<<<<
 ...
 */
      for (__pyx_t_13 = 0; __pyx_t_13 < 3; __pyx_t_13+=1) {
        ...
        /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":28
 * 
 *       for c in range(3):
 *         img_blended[i, j, c] = int((img_back[i, j, c] * alpha1 * (1 - alpha2) + img_front[i, j, c] * alpha2) / alpha)             # <<<<<<<<<<<<<<
 *       img_blended[i, j, 3] = int(alpha * 255)
 */
        ...
        *((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_blended.data + __pyx_t_20 * __pyx_v_img_blended.strides[0]) ) + __pyx_t_21 * __pyx_v_img_blended.strides[1]) ) + __pyx_t_22 * __pyx_v_img_blended.strides[2]) )) = ((__pyx_t_5numpy_uint8_t)(((((*((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_back.data + __pyx_t_14 * __pyx_v_img_back.strides[0]) ) + __pyx_t_15 * __pyx_v_img_back.strides[1]) ) + __pyx_t_16 * __pyx_v_img_back.strides[2]) ))) * __pyx_v_alpha1) * (1.0 - __pyx_v_alpha2)) + ((*((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_front.data + __pyx_t_17 * __pyx_v_img_front.strides[0]) ) + __pyx_t_18 * __pyx_v_img_front.strides[1]) ) + __pyx_t_19 * __pyx_v_img_front.strides[2]) ))) * __pyx_v_alpha2)) / __pyx_v_alpha));
      }

      /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":29
 *       for c in range(3):
 *         img_blended[i, j, c] = int((img_back[i, j, c] * alpha1 * (1 - alpha2) + img_front[i, j, c] * alpha2) / alpha)
 *       img_blended[i, j, 3] = int(alpha * 255)             # <<<<<<<<<<<<<<
 */
      ...
      __pyx_t_25 = 3;
      *((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_img_blended.data + __pyx_t_23 * __pyx_v_img_blended.strides[0]) ) + __pyx_t_24 * __pyx_v_img_blended.strides[1]) ) + __pyx_t_25 * __pyx_v_img_blended.strides[2]) )) = ((__pyx_t_5numpy_uint8_t)(__pyx_v_alpha * 255.0));
    }
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_1AlphaBlend(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_1AlphaBlend(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_img_back = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_img_front = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_img_blended = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("AlphaBlend (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_img_back,&__pyx_n_s_img_front,&__pyx_n_s_img_blended,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img_back)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img_front)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AlphaBlend", 1, 3, 3, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_img_blended)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("AlphaBlend", 1, 3, 3, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "AlphaBlend") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_img_back = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_nn___pyx_t_5numpy_uint8_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img_back.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_img_front = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_nn___pyx_t_5numpy_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img_front.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_img_blended = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_nn___pyx_t_5numpy_uint8_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_img_blended.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("AlphaBlend", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("vrsubtitlemaker.add_patterns_lib.alpha_blend.AlphaBlend", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_AlphaBlend(__pyx_self, __pyx_v_img_back, __pyx_v_img_front, __pyx_v_img_blended);
...
static PyObject *__pyx_pf_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_AlphaBlend(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_img_back, __Pyx_memviewslice __pyx_v_img_front, __Pyx_memviewslice __pyx_v_img_blended) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("AlphaBlend", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_img_back.memview)) { __Pyx_RaiseUnboundLocalError("img_back"); __PYX_ERR(0, 10, __pyx_L1_error) }
  if (unlikely(!__pyx_v_img_front.memview)) { __Pyx_RaiseUnboundLocalError("img_front"); __PYX_ERR(0, 10, __pyx_L1_error) }
  if (unlikely(!__pyx_v_img_blended.memview)) { __Pyx_RaiseUnboundLocalError("img_blended"); __PYX_ERR(0, 10, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_AlphaBlend(__pyx_v_img_back, __pyx_v_img_front, __pyx_v_img_blended, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_img_back, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_img_front, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_img_blended, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "vrsubtitlemaker.add_patterns_lib.alpha_blend.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "vrsubtitlemaker.add_patterns_lib.alpha_blend.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "vrsubtitlemaker.add_patterns_lib.alpha_blend.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "vrsubtitlemaker.add_patterns_lib.alpha_blend._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"AlphaBlend", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15vrsubtitlemaker_16add_patterns_lib_11alpha_blend_1AlphaBlend, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_alpha_blend(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_alpha_blend},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_img_blended, __pyx_k_img_blended, sizeof(__pyx_k_img_blended), 0, 0, 1, 1},
  {&__pyx_n_s_img_front, __pyx_k_img_front, sizeof(__pyx_k_img_front), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initalpha_blend(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initalpha_blend(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_alpha_blend(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_alpha_blend(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_alpha_blend(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'alpha_blend' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_alpha_blend(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("alpha_blend", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_vrsubtitlemaker__add_patterns_lib__alpha_blend) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "vrsubtitlemaker.add_patterns_lib.alpha_blend")) {
      if (unlikely(PyDict_SetItemString(modules, "vrsubtitlemaker.add_patterns_lib.alpha_blend", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":2
 ...
 */
  ...
  /* "vrsubtitlemaker/add_patterns_lib/alpha_blend.pyx":1
 * from libc cimport math             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init vrsubtitlemaker.add_patterns_lib.alpha_blend", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init vrsubtitlemaker.add_patterns_lib.alpha_blend");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
