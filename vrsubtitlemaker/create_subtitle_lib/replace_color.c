...
#define __PYX_HAVE__vrsubtitlemaker__create_subtitle_lib__replace_color
#define __PYX_HAVE_API__vrsubtitlemaker__create_subtitle_lib__replace_color
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
/* Module declarations from 'vrsubtitlemaker.create_subtitle_lib.replace_color' */
...
static PyObject *__pyx_f_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_ReplaceColorCython(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "vrsubtitlemaker.create_subtitle_lib.replace_color"
extern int __pyx_module_is_main_vrsubtitlemaker__create_subtitle_lib__replace_color;
int __pyx_module_is_main_vrsubtitlemaker__create_subtitle_lib__replace_color = 0;

/* Implementation of 'vrsubtitlemaker.create_subtitle_lib.replace_color' */
...
static PyObject *__pyx_pf_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_ReplaceColorCython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_font_color, __Pyx_memviewslice __pyx_v_bg_color); /* proto */
...
/* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":11
...
static PyObject *__pyx_pw_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_1ReplaceColorCython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_ReplaceColorCython(__Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_font_color, __Pyx_memviewslice __pyx_v_bg_color, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_c;
  int __pyx_v_height;
  ...
  __Pyx_RefNannySetupContext("ReplaceColorCython", 0);

  /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":14
 *   cdef:
 *     int i, j, c
 ...
 */
  ...
  /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":15
 *     int i, j, c
 *     int height = image.shape[0]
 *     int width = image.shape[1]             # <<<<<<<<<<<<<<
 *     int n_channels = image.shape[2]
 ...
 */
  ...
  /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":16
 *     int height = image.shape[0]
 *     int width = image.shape[1]
 *     int n_channels = image.shape[2]             # <<<<<<<<<<<<<<
 *   for i in range(height):
 ...
 */
  __pyx_v_n_channels = (__pyx_v_image.shape[2]);

  /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":17
 *     int width = image.shape[1]
 *     int n_channels = image.shape[2]
 *   for i in range(height):             # <<<<<<<<<<<<<<
 *     for j in range(width):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":18
 *     int n_channels = image.shape[2]
 *   for i in range(height):
 *     for j in range(width):             # <<<<<<<<<<<<<<
 *       if image[i,j,0] < 100:
 ...
 */
    ...
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      ...
      /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":19
 *   for i in range(height):
 *     for j in range(width):
 *       if image[i,j,0] < 100:             # <<<<<<<<<<<<<<
 *         for c in range(n_channels):
 ...
 */
      ...
      __pyx_t_8 = __pyx_v_j;
      __pyx_t_9 = 0;
      __pyx_t_10 = (((*((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_7 * __pyx_v_image.strides[0]) ) + __pyx_t_8 * __pyx_v_image.strides[1]) ) + __pyx_t_9 * __pyx_v_image.strides[2]) ))) < 0x64) != 0);
      if (__pyx_t_10) {

        /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":20
 *     for j in range(width):
 *       if image[i,j,0] < 100:
 *         for c in range(n_channels):             # <<<<<<<<<<<<<<
 *           image[i,j,c] = font_color[c]
 ...
 */
        ...
        for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
          ...
          /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":21
 *       if image[i,j,0] < 100:
 *         for c in range(n_channels):
 *           image[i,j,c] = font_color[c]             # <<<<<<<<<<<<<<
 *       else:
 ...
 */
          ...
          *((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_15 * __pyx_v_image.strides[0]) ) + __pyx_t_16 * __pyx_v_image.strides[1]) ) + __pyx_t_17 * __pyx_v_image.strides[2]) )) = (*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_font_color.data + __pyx_t_14 * __pyx_v_font_color.strides[0]) )));
        }
 ...
 */
      ...
      /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":23
 *           image[i,j,c] = font_color[c]
 *       else:
 *         for c in range(n_channels):             # <<<<<<<<<<<<<<
 ...
 */
      /*else*/ {
        ...
        for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
          ...
          /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":24
 *       else:
 *         for c in range(n_channels):
 *           image[i,j,c] = bg_color[c]             # <<<<<<<<<<<<<<
 */
          ...
          *((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_19 * __pyx_v_image.strides[0]) ) + __pyx_t_20 * __pyx_v_image.strides[1]) ) + __pyx_t_21 * __pyx_v_image.strides[2]) )) = (*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_bg_color.data + __pyx_t_18 * __pyx_v_bg_color.strides[0]) )));
        }
      }
      __pyx_L7:;
    }
...
/* Python wrapper */
static PyObject *__pyx_pw_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_1ReplaceColorCython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_1ReplaceColorCython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_image = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_font_color = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_bg_color = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("ReplaceColorCython (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_image,&__pyx_n_s_font_color,&__pyx_n_s_bg_color,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_font_color)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ReplaceColorCython", 1, 3, 3, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bg_color)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("ReplaceColorCython", 1, 3, 3, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "ReplaceColorCython") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_nn___pyx_t_5numpy_uint8_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_font_color = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_font_color.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_bg_color = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_uint8_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_bg_color.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("ReplaceColorCython", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("vrsubtitlemaker.create_subtitle_lib.replace_color.ReplaceColorCython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_ReplaceColorCython(__pyx_self, __pyx_v_image, __pyx_v_font_color, __pyx_v_bg_color);
...
static PyObject *__pyx_pf_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_ReplaceColorCython(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_font_color, __Pyx_memviewslice __pyx_v_bg_color) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  if (unlikely(!__pyx_v_font_color.memview)) { __Pyx_RaiseUnboundLocalError("font_color"); __PYX_ERR(0, 11, __pyx_L1_error) }
  if (unlikely(!__pyx_v_bg_color.memview)) { __Pyx_RaiseUnboundLocalError("bg_color"); __PYX_ERR(0, 11, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_ReplaceColorCython(__pyx_v_image, __pyx_v_font_color, __pyx_v_bg_color, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_font_color, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_bg_color, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "vrsubtitlemaker.create_subtitle_lib.replace_color.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "vrsubtitlemaker.create_subtitle_lib.replace_color.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "vrsubtitlemaker.create_subtitle_lib.replace_color.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "vrsubtitlemaker.create_subtitle_lib.replace_color._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"ReplaceColorCython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15vrsubtitlemaker_19create_subtitle_lib_13replace_color_1ReplaceColorCython, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_replace_color(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_replace_color},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initreplace_color(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initreplace_color(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_replace_color(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_replace_color(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_replace_color(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'replace_color' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_replace_color(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("replace_color", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_vrsubtitlemaker__create_subtitle_lib__replace_color) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "vrsubtitlemaker.create_subtitle_lib.replace_color")) {
      if (unlikely(PyDict_SetItemString(modules, "vrsubtitlemaker.create_subtitle_lib.replace_color", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":2
 ...
 */
  ...
  /* "vrsubtitlemaker/create_subtitle_lib/replace_color.pyx":1
 * from libc cimport math             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init vrsubtitlemaker.create_subtitle_lib.replace_color", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init vrsubtitlemaker.create_subtitle_lib.replace_color");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
